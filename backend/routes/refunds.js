      ...
      if (!grouped.has(refundId)) {
        grouped.set(refundId, {
          ...
          order: row.order_id ? {
            ...
            board_station_id: row.order_board_station_id ? Number(row.order_board_station_id) : null,
            exit_station_id: row.order_exit_station_id ? Number(row.order_exit_station_id) : null,
