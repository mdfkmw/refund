              ...
              <article key={trip.trip_id} className="trip-card overflow-hidden">
                <div className="flex flex-col md:flex-row md:items-stretch">
                  <div className="flex-1 p-5 md:p-7 space-y-6">
                    <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(140px,1fr)_minmax(0,1fr)] lg:items-center">
                      {/* Plecare */}
                      <div className="lg:justify-self-start">
                        <div className="text-white/80 text-sm">
                          <span className="font-semibold text-white">{boardLocationParts.city}</span>
                      ...
                      {/* Linie (între ele pe mobil / îngust) */}
                      <div className="text-center route-line-demo">


                        {/* Afișează linia doar când suntem pe același rând (lg+) */}
                        <div className="hidden lg:block line no-arrow" />
                      ...
                      {/* Sosire */}
                      <div className="lg:text-right lg:justify-self-end">
                        <div className="text-white/80 text-sm">
                          <span className="font-semibold text-white">{exitLocationParts.city}</span>
                          {exitLocationParts.details && (
                            <span className="text-white/80">, {exitLocationParts.details}</span>
                          )}
                        </div>
                        <div className="text-3xl font-bold text-brand">{exitTime || '—'}</div>
