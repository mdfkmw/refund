...
export const productsAndServices = [
  'Transport rutier de persoane pe trasee regulate.',
  'Rezervarea și emiterea online a biletelor de călătorie.',
  'Procesarea plăților prin eBTpay pentru bilete.',
  'Servicii de închiriere autobuze și microbuze pentru curse ocazionale.',
]
